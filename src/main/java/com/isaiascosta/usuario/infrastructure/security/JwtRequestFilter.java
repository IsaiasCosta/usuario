package com.isaiascosta.usuario.infrastructure.security;
...
public class JwtRequestFilter extends OncePerRequestFilter {
   ...
   private String buildError(int status, String mensagem, String path, String error) {
      ...
      objetcMapper.registerModule(new JavaTimeModule());
      objetcMapper.disable(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS);

      try {
         return objetcMapper.writeValueAsString(errorResponseDTO);
